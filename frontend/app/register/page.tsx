    ...
    <main className="min-h-screen bg-slate-50">
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid gap-12 items-center lg:grid-cols-2">
          <div className="relative overflow-hidden rounded-[2rem] shadow-2xl min-h-[560px] lg:min-h-[600px]">
            <Image
            ...
            <div className="absolute inset-0 flex flex-col justify-start items-center px-8 lg:px-12 pt-16 text-white">
          ...
          <div className="bg-white rounded-[2rem] border border-slate-200 p-6 shadow-2xl sm:p-8">
            ...
            <div className="space-y-3">
              <button className="flex w-full items-center justify-center gap-3 rounded-full border border-slate-300 bg-white px-4 py-2.5 text-sm font-medium text-slate-700 shadow-sm transition hover:bg-slate-50">
